...
const PublicProfile = () => {
    ...
    return (
        <div className="min-h-screen bg-[#080f0f] bg-gradient-to-br from-[#050d0d] via-[#080f0f] to-[#0a1716] text-white p-4 sm:p-8 flex items-center justify-center selection:bg-cyan-500/30">
            <div className="w-full max-w-4xl bg-[#112523]/30 backdrop-blur-xl rounded-3xl border border-cyan-500/10 shadow-2xl p-6 sm:p-10 relative overflow-hidden group">
                ...
                {/* 🚀 ADDED CONTENT ACCELERATOR: CODING STATS GRAPH */}
                <div className="mt-8 pt-6 border-t border-cyan-500/5">
                    <h3 className="text-xs uppercase tracking-widest text-cyan-500 font-bold mb-4 text-center md:text-left">Challenge Verification Engine</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div className="bg-[#0b1414] border border-cyan-500/5 p-4 rounded-2xl">
                            <span className="text-gray-500 text-xs block">75-Day Challenge</span>
                            <span className="text-xl font-bold text-slate-200 block mt-1">Active 🔥</span>
                        </div>
                        <div className="bg-[#0b1414] border border-cyan-500/5 p-4 rounded-2xl sm:col-span-2">
                            <div className="flex justify-between text-xs text-gray-400 mb-1.5">
                                <span>Target Profile Target Status</span>
                            ...
                            <div className="w-full bg-cyan-950/60 h-2.5 rounded-full overflow-hidden border border-cyan-500/10">
                                <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-full w-[65%] rounded-full animate-pulse"></div>
                            </div>
                        </div>
                    </div>
                </div>
